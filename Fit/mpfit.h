...
/* This is a C library.
 * Allows compilation with a C++ compiler
 */
#ifdef __cplusplus
extern "C" {
#endif
...
struct mp_par_struct {
  ...
  int limited[2];   /* 1 = low/upper limit;
                       0 = no limit
                     */
  ...
  int deriv_debug;  /* Derivative debug mode:
...
struct mp_result_struct {
  ...
  int nfunc;           /* Number of residuals (= number of data points) */
